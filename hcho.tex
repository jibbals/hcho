...
\introduction  %% \introduction[modified heading if necessary]
  ...
  Emissions of isoprene (C$_5$H$_8$) may be overestimated in Australia.
...
\section{Methods and data}
  ...
  \subsection{Calculation of Emissions}
    ...
    By replacing $\Omega_{HCHO}$ and $B$ with OMI based values, the $E_{isop}$ is the only unknown.
    The $B$ackground from OMI  is determined using the mean column HCHO measured over the remote pacific ocean (180-120$^{\circ}$W, 10-60$^{\circ}$S).
    This is gives us a background which is appropriate for the Australian latitudes, and is shown in Figure TODO: figure with background region highlighted and a time series of background values.
